        ...
        items: [
          {
            ...
            description: [
              'Review GameChanger updates with the 🧠 icon, and have your son watch the videos.',
              'Take a look at Sports Lab 360 and Anytime Soccer Training.',
              "When you understand what we're building toward, you can reinforce it at home and have better conversations with your son.",
            ],
          },
          {
            icon: IconTarget,
            ...
            description: [
              "The Individual Development Plan is your son's roadmap for the season.",
              'Review it together, ask him about his goals, and celebrate small wins along the way.',
            ],
          },
          {
            icon: IconBallFootball,
            ...
            description: [
              'Ball mastery — juggling, wall passing, 3 cone drills, etc. Anytime Soccer Training makes this easy.',
              'In Arizona heat, inside works great. Consider the "House Ball" — designed for indoor use on hard floors.',
              'Try this for a week: just have the ball at your feet during daily activities. The results will surprise you.',
            ],
          ...
          },
          {
            ...
            description: [
              'Pull up a Premier League or MLS match and watch it together.',
              'Talk about it: what did the striker do without the ball? Why did the midfielder switch the play?',
            ],
          },
          {
            icon: IconBrain,
            ...
            description: [
              'Seriously. Football video games build tactical pattern recognition.',
              'Players who understand formations, spacing, and pressing from video games see the field differently.',
              'Players who are fans of the game and its players develop a deeper love for the sport and mimic their heroes on the field.',
            ],
          },
        ],
      },
